  ...
  switch (distribution.id) {
    ...
    case "student": {
      ...
      return {
        ...
        domain: [-Math.max(5, Math.sqrt(df) * 3.2), Math.max(5, Math.sqrt(df) * 3.2)]
      };
    }
    case "chiSquared": {
      ...
      return {
        ...
        domain: [0, Math.max(6, df + 6 * Math.sqrt(2 * df))]
      };
    }
    case "fDistribution": {
      ...
      return {
        ...
        domain: [0, Math.max(5, df2 / Math.max(1, df2 - 2) * 5)]
      };
    }
    case "exponential": {
    ...
    case "cauchy": {
      ...
      return {
        ...
        domain: [x0 - 12 * gamma, x0 + 12 * gamma]
      };
    }
    case "weibull": {
      ...
      return {
        ...
        domain: [0, lambda * Math.max(4, (-Math.log(0.001)) ** (1 / k))]
      };
    }
    case "gamma": {
      ...
      return {
        ...
        domain: [0, Math.max(6 * theta, alpha * theta + 6 * Math.sqrt(alpha) * theta)]
      };
    }
    case "beta": {
      const alpha = value(params, "alpha", 2);
